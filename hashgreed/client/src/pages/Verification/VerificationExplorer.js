...
import { FaPaste, FaRegFilePdf, FaFileContract } from "react-icons/all";
...
function VerificationExplorer({ match }) {
  ...
  const Search = async () => {
    ...
    await ApiUtils.searchCertification(
      transactionID,
      hashID,
      reference,
      setCertification
  ...
  const poc = useDropzone({ onDrop: onCertDrop, maxSize: 5 * 1024 * 1024 });
  ...
  const fth = useDropzone({ onDrop: onFileDrop, maxSize: 5 * 1024 * 1024 });

  const DownloadCertificate = () => {
    let hashTitle = certification.hash
      ? "File hash"
      : certification.messageid
      ? "Messge ID"
      : null;
  ...
  return (
    <div className={styles.verficationExplorer}>
      <div className={styles.container}>
        <div
          className={styles.verificationTitle}
                  ...
                  <div className={styles.main}>
                    ...
                    <div className={styles.dataArea}>
                      ...
                      >
                        ...
                        <br />
                        {certification.hash ? "File hash" : "Message ID"}:{" "}
                        <b>{certification.hash || certification.messageid}</b>{" "}
                        <br />
                        TxID: <b>{certification.txid}</b>
                      </div>
                      <div
                        className={styles.certDataMob}
                        style={{ color: theme.primaryText }}
                      >
                          ...
                          certification.address.length > 20 ? (
                            <div className={styles.clipboard}>
                              <div className={styles.txclipboard}>
                                By:&nbsp;
                                <b>
                                  {certification.address.slice(0, 20) + "..."}
                                </b>
                              </div>
                          ...
                          certification.title.length > 20 ? (
                            <div className={styles.clipboard}>
                              <div className={styles.txclipboard}>
                                Reference:&nbsp;
                                <b>
                                  {certification.title.slice(0, 20) + "..."}
                                </b>
                              </div>
                          ...
                          certification.reference.length > 20 ? (
                            <div className={styles.clipboard}>
                              <div className={styles.txclipboard}>
                                Reference:&nbsp;
                                <b>
                                  {certification.reference.slice(0, 20) + "..."}
                                </b>
                              </div>
                      ...
                      <div className={styles.qrArea}>
                        ...
                        <a
                          href={`${WavesConfig.EXPLORER_URL}/tx/${certification.txid}`}
                          style={{ color: theme.primaryText }}
                        >
                  ...
                  <div className={styles.item}>
                    <div className={styles.header}>
                      ...
                      <QRCode
                        ...
                        includeMargin={true}
                        className={styles.qrpdf}
                      />
                    </div>
                    <div className={styles.titleArea}>
                      <div
                        className={styles.proof}
                        style={{ color: theme.certificationText }}
                      >
                        <b>Proof</b>
                      </div>
                      ...
                      >
                        <b>
                          You certified the following data on waves blockchain
                        </b>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <br />
                      {certification.hash ? "File Hash" : "Message ID"}: <br />
                      <div
                        className={styles.imgHash}
                        style={{
                          color: theme.certificationText,
                          fontWeight: "500",
                          paddingRight: "30px",
                          marginBottom: "10px",
                        }}
                    ...
                    {certification.status ? (
                      <span className={styles.status}>
                        <a
                          href={
                            "http://wavesexplorer.com/tx/" +
                            certification.status.replace("REVOKED_", "")
                          }
                          target="_blank"
                          rel="noreferrer"
                        >

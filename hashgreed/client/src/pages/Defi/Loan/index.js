    ...
    <div className={styles.loan}>
      <div className={styles.container}>
        ...
        <div className={styles.buttonArea}>
          <span className={cx(styles.button, collateralAmount === 0 ? styles.disabled : styles.filled, styles.loanButton)} style={{ backgroundColor: collateralAmount === 0 ? theme.disabledButtonBack : theme.buttonBack }}  onClick={collateralAmount === 0 ? null : () => requestLoan()} >Request Loan</span>
          <span className={cx(styles.button, curLoanAmount === 0 ? styles.disabled: styles.filled, styles.loanButton)} style={{ backgroundColor: curLoanAmount === 0 ? theme.disabledButtonBack : theme.buttonBack }} onClick={() => curLoanAmount !== 0?gotoRepay() : null}>Repay Loan</span>
        </div>
      </div>
    </div>
  )

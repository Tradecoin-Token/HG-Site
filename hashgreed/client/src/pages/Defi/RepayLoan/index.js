    ...
    <div className={styles.repay}>
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.totalBorrowed} style={{ color: theme.buttonBack }}> Total Borrowed: <div style={{ color: theme.primaryText, marginLeft: '10px' }}>{currentAmount} USDT</div> </div>
        </div>
        ...
        <div className={styles.buttonArea}>
          <span className={cx(styles.button, styles.filled, styles.continueButton)} style={{ backgroundColor: theme.buttonBack }} onClick={() => repayLoan()}>Continue</span>
        </div>
      </div>
    </div>
  )

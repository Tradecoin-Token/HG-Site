        ...
        <div className={styles.verficationExplorer}>
            <div className={styles.container} style={{color: theme.primaryText, textAlign:'justify'}}>
                ...
                <div className={styles.faqData}>
                    ...
                    <br/><br/>
                    <b>11. How do i get the Currency ID of any waves based asset?</b>
                    <br/><br/>
                    You can get the Currency ID of any Waves based asset by going to your waves.exchange account and clicking on the Assets tab. Then click or search for any currency of your choice and copy the ID.
                    <br/>
                    However, here are the Currency IDs of the featured Assets on Hashgreed.
                    <br/><br/>
